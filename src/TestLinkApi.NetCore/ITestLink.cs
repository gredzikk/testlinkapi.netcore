...
namespace TestLinkApi {
    ...
    public interface ITestLink : IXmlRpcProxy {
        ...
        object getTestCaseCustomFieldDesignValue(string devKey, int testcaseid, string testcaseexternalid, int version, int testprojectid, string customfieldname, string details);
